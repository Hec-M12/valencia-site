...
export default function HeroSedePrincipal() {
  return (
    <section
      id="inicio"
      ...
      <div className="relative z-10 container mx-auto w-full px-6">
        <div className="w-full grid lg:grid-cols-2 gap-8 lg:gap-12 items-center text-center">
          <div>
            ...
            <p className="mt-6 text-base md:text-lg text-valencia-blue/80">
              Bienvenidos a nuestra sede principal, un espacio donde la innovación educativa y la formación en valores
              guían cada etapa del aprendizaje.
            </p>
          </div>
