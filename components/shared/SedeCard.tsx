    ...
    >
      <div className="p-8">
        ...
        <div className="flex justify-center">
          <a
            href={href}
            className="w-[65%] md:w-[40%] lg:w-[40%] bg-valencia-blue font-semibold text-white py-2 rounded hover:bg-valencia-blue/70 transition-colors duration-300 text-center block"
          >
            Conocer más
          </a>
        </div>
